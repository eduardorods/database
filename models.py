...
class CRIEvento(Base):
    __tablename__ = "cri_evento"
    ...
    tipo_documento: Mapped[str | None] = mapped_column(String)  # 'ATA' | 'ADITAMENTO'
    nome_arquivo: Mapped[str | None] = mapped_column(String)
    data_evento: Mapped[str | None] = mapped_column(String)
